		...
		general: {
			...
			taskIdentification: {
				...
				taskPropertyValue: {
					...
					description: "Значение, которое идентифицирует заметку как задачу (например, \"задача\"). Оставьте пустым, чтобы соответствовать любому значению — заметка становится задачей, как только это свойство присутствует."
				}
			},
			folderManagement: {
